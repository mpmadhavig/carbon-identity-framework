    ...
    protected void activate(ComponentContext ctxt) {
        try {
            ...
            try {
                ...
                KeyStoreJDBCPersistenceManager keyStoreJDBCPersistenceManager = KeyStoreJDBCPersistenceManager.getInstance();
                if (System.getProperty("setup") == null) {
                    ...
                    KeyStoreJDBCPersistenceManager.initializeDatabase();
                }
