...
public class IdentityApplicationConstants {
    ...
    public static final String ALL_ATTRIBUTES_ALLOWED_SP_PROPERTY_NAME
            = "allAttributesAllowed";
    public static final String ALL_ATTRIBUTES_ALLOWED_SP_PROPERTY_DISPLAY_NAME
